...
if (isEntrypoint()) {
  ...
  // the lane's own plumbing rather than by anything wrong with the app.
  // This outlived the local-binary path it was first added for: the artifact
  // scan, the module resolution and the sidecar probe are all still unguarded
